    ...
    <ul className="list-none">
        {todos.map((todo) => (
          ...
          />    
            ...
            <button className='px-3 py-1  mx-2 text-center rounded-md bg-gray-600' onClick={()=>handleEdit(todo.id)}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
